...
if __name__ == '__main__':
    ...
    file_handler = logging.FileHandler(
        os.path.join(param.log_folder, param.path + "_" + str(param.ratio) + "_" + str(param.oppratio) + "_log.txt"))
    ...
    logging.info(
        'Total Opportunities: %d Triple dimension: %d Anomaly amount: %d.' % (opportunities, dimension, anomaly_amount))
